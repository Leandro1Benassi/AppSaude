...
import CardMedicao from '../../assets/components/CardMedicao';
...
const Medicoes: React.FC = () => {
    ...
    async function loadData() {
        ...
        try {
            ...
            const response = await api.get(`Medicao/listar.php`);
        ...
        //setSucess(true);
           try {
            ...
            if(id_user != null){
                ...
                await api.post(`Medicao/atualizar.php?&id_user=${id_user.replace(/['"]+/g, '')}`);
            ...
            <View style={{ paddingHorizontal: 15, flex: 1, }}>
                ...
                <View style={styles.containerFloat}>
                    ...
                    <TouchableOpacity
                        ...
                        onPress={() => navigation.navigate("NovoMedicao", { id_reg: '0' })}
                    >
